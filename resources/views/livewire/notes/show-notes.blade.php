...
<div>
    <div class="space-y-2">
        ...
        <div class="text-center">
            ...
            <x-button icon="plus" flat primary interaction:solid class="mt-6" href="{{ route('notes.create') }}" wire:navigate>Create
                note</x-button>
        </div>
        @else
            ...
            <x-card wire:key='{{ $note->id }}'>
                ...
                <div class="flex items-end justify-between mt-4 space-x-1">
                    ...
                    <div>
                        ...
                        <x-mini-button rounded info class="color-blue" icon="eye" a href="{{route('notes.view', $note) }}"></x-mini-button>
                        <x-mini-button icon="trash" wire:click="delete('{{ $note->id }}')">del</x-mini-button>
                    </div>
                </div>
            </x-card>
            @endforeach
